...
{{--              <a onclick="return confirm('Bạn có chắc là muốn xóa bình luận này ko?')" href="{{URL::to('/delete-comment/'.$comm->comment_id)}}" class="active styling-edit" ui-toggle-class="">--}}
